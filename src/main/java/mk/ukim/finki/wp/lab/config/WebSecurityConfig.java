...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .permitAll()
                        .requestMatchers("/books/add-form", "/books/add", "/books/edit/**", "/books/delete/**").hasRole("ADMIN")
                        .anyRequest()
                        .authenticated()
                )
                .formLogin((form) -> form
    ...
    public UserDetailsService userDetailsService() {
        ...
        UserDetails user1 = User.builder()
                .username("martina")
                .password(passwordEncoder.encode("martina"))
                .roles("USER")
                .build();
        UserDetails user2 = User.builder()
                .username("andrej")
                .password(passwordEncoder.encode("andrej"))
                .roles("USER")
                .build();
